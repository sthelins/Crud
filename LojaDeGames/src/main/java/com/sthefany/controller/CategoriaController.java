package com.sthefany.controller;
...
import com.sthefany.model.Categoria;
import com.sthefany.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>> getByTipo(@PathVariable String marca) {
		return ResponseEntity.ok(categoriaRepository.findAllByTipoContainingIgnoreCase(marca));
	}
